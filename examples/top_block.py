...
# Title: Top Block
# Generated: Tue Dec 11 17:20:04 2018
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.gain_index = gain_index = 200
        self.gain = gain = 0
        ...
        self._gain_index_range = Range(0, 255, 1, 200, 200)
        self._gain_index_win = RangeWidget(self._gain_index_range, self.set_gain_index, 'Gain Index', "counter_slider", int)
